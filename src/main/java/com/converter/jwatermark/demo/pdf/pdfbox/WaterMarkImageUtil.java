...
public class WaterMarkImageUtil {
    ...
    public static void main(String[] args) {
        try {
            watermark(new File("D:\\1-尚硅谷项目课程系列之Elasticsearch.pdf"),"D:\\watermark.pdf",30);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    private static void watermark(File file, String path,double theta) throws Exception {
        //创建新pdf文件
